...
//i : sert a bouger dans le tableau , il permet de changer le nombre (1,2 ou " ") a chaque passager utilisateur , i c donc les ligne 
//j : sert a bouger dans le tableau ,  il permet de changer le nombre (1,2 ou " ") a chaque passager utilisateur , c donc les colone
namespace Morpion
{
    class ProgrameMorpi // classe du jeux
    {
        public static int[,] grille = new int[3, 3]; // grille 3x3 pour jeu, sa s'appelle une matrice
                                                     ...
                                                     //[,] : la virgule c pr dire que c un tableau de tableau, chaque "petit" tableau vaut 0 nativement 
        ...
        public static void AfficherMorpion()
        {
            ...
            Console.WriteLine(" -----------");  //j'ai mis cette ligne ici car pour une raison inconue je ne peut pas mettre 4 ligne dans le if j ci dessous. (problème a revoir)
...

        {
...

            {
                ...
                while (!validLigne)
                {
                    ...
                    {
                        Console.WriteLine("pas bon, saisir une ligne entre 1 et 3.");
                    }
                }
                ...
                while (!validColonne)
                {
                    ...
                    {
                        Console.WriteLine("pas bon saisir une colonne entre 1 et 3.");
                    }
                }
                ...
                {
                    Console.WriteLine("pas bon mouvement , refaire :");
                }
            }
